...
#					self.newData['CMOS'][str(crate)][str(card)][str(channel)]['timestamp']=time.time()
    ...
    def init_crate(self):
        ...
        self.PollingText= self.crateView.create_text((self.margin_left+10*self.cell_padding+9*self.cell_width,0.5*self.margin_top),text="Polling 0 crates",fill='black',font= ("helvetica", 18),anchor= Tkinter.W)
