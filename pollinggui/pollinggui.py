...
#					self.newData['CMOS'][str(crate)][str(card)][str(channel)]['timestamp']=time.time()
    ...
    def init_crate(self):
        ...
        self.PollingBox=self.crateView.create_rectangle(self.margin_left+10*self.cell_padding+9*self.cell_width, 0.5*self.margin_top-20, self.margin_left+10*self.cell_padding+19*self.cell_width,0.5*self.margin_top+20,outline="black",fill='grey')
